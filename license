...
Clearpath Robotics, Inc. and The University of Toronto and their affiliates (hereinafter “Licensors”) strive to enhance public access to and use of data that they collect, annotate, and publish. The data are organized in datasets (the “Datasets”) listed at [https://github.com/Viky397/TorWICDataset] (the “Website”). The Datasets are collections of data, managed by Licensors and provided in a number of machine-readable formats. Licensors provide any individual or entity (hereinafter You” or “Your”) with access to the Datasets free of charge subject to the terms of this agreement (hereinafter “Dataset Terms”). Use of any data derived from the Datasets, which may appear in any format such as tables, charts, devkit, documentation, or code, is also subject to these Dataset Terms. By downloading any Datasets or using any Datasets, You are agreeing to be bound by the Dataset Terms. If you are downloading any Datasets or using any Datasets for an organization, you are agreeing to these Dataset Terms on behalf of that organization. If you do not have the right to agree to these Dataset Terms, do not download or use the Datasets.

## Licenses

Unless specifically labeled otherwise, these Datasets are provided to You under a Creative Commons Attribution-NonCommercial 4.0 International Public License (“CC BY-NC 4.0”), with the additional terms included in these Dataset Terms. The CC BY-NC 4.0 may be accessed at https://creativecommons.org/licenses/by-nc/4.0/legalcode. When You download or use the Datasets from the Website or elsewhere, You are agreeing to comply with the terms of CC BY-NC 4.0. Where these Dataset Terms conflict with the terms of CC BY-NC 4.0, these Dataset Terms will control.

## Privacy

Licensors prohibit You from using the Datasets in any manner to identify or invade the privacy of any person whose personally identifiable information or personal data may have been incidentally collected in the creation of this Dataset, even when such use is otherwise legal. An individual with any privacy concerns, including a request to remove your personally identifiable information or personal data from the Dataset, may contact us by sending an e-mail to [jservos@clearpath.ai].
...
These Terms of Use will be governed by and interpreted in accordance with the laws of Ontario (excluding the conflict of laws rules thereof). All disputes under these Dataset Terms will be resolved in the applicable province or federal courts of Ontario, Canada. You consent to the jurisdiction of such courts and waive any jurisdictional or venue defenses otherwise available.
